...
- Replaced the generic responsive card shell with fixed design frames: mobile `390x844`, PC `1360x820`.
...
- Spacing and layout rhythm: matches the source frame sizes, top-nav height, PC content card placement, mobile header spacing, and bottom nav/drawer placement.
